...
const get = (obj, path, defaultValue = undefined) => {
  ...
  // Check if the path contains '-public' and set config.publicFiles accordingly
  if (typeof path === 'string' && path.includes('-public')) {
    obj.config = obj.config || {};
    obj.config.publicFiles = true;
  } else {
    obj.config = obj.config || {};
    obj.config.publicFiles = false;
  }
